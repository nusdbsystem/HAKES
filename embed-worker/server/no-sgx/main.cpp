...
int main(int argc, char* argv[]) {
  ...
  hakes::Service s{
      std::unique_ptr<hakes::ServiceWorker>(new embed_worker::EmbedWorker(
          std::unique_ptr<embed_worker::Worker>(
              new embed_worker::WorkerImpl(std::unique_ptr<hakes::Store>(
...
//  UV_THREADPOOL_SIZE=10 ./install/bin/embed_server_no_sgx 2355 tmp 0
