...
#ifndef HAKES_EMBEDWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
#define HAKES_EMBEDWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
...
#endif  // HAKES_EMBEDWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
