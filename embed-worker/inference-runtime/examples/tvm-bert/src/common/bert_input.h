...
#ifndef HAKES_EMBEDWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
#define HAKES_EMBEDWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
...
#endif  // HAKES_EMBEDWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
