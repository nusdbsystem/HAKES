...
COMMON_INCLUDE_FLAGS = -Isrc/trusted -I${PROJECT_ROOT_DIR}/include -I$(PROJECT_ROOT_DIR)/include/hakes-worker/trusted -I${HAKES_ROOT}
...
src/trusted/Enclave_t.c: $(SGX_EDGER8R) ${PROJECT_ROOT_DIR}/include/hakes-worker/trusted/Enclave.edl
	@echo Entering ./src/trusted
	cd ./src/trusted && $(SGX_EDGER8R) --trusted ${PROJECT_ROOT_DIR}/include/hakes-worker/trusted/Enclave.edl --search-path $(PROJECT_ROOT_DIR)/include --search-path $(SGX_SDK)/include --search-path $(SGXSSL_DIR)/include --search-path $(SGX_RA_TLS_DIR)/include --search-path $(HAKES_ROOT) $(Enclave_Search_Dirs)
	@echo "GEN  =>  $@"
...
src/trusted/hexutil.o: ${HAKES_ROOT}/utils/hexutil.cpp
	$(CXX) ${Enclave_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
...
src/trusted/search_result_agg.o: src/common/search_result_agg.cpp
	$(CXX) ${Enclave_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
...
### Enclave Image ###
Enclave_Cpp_Objects := src/trusted/base64.o src/trusted/json.o src/trusted/hexutil.o src/trusted/tcrypto_ext.o src/trusted/channel_client.o src/trusted/keyservice_worker.o src/trusted/search_result_agg.o src/trusted/ecalls.o
