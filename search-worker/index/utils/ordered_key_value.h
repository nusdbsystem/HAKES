...
#ifndef HAKES_SEARCHWORKER_INDEX_UTILS_ORDERED_KEY_VALUE_H_
#define HAKES_SEARCHWORKER_INDEX_UTILS_ORDERED_KEY_VALUE_H_
...
#endif  // HAKES_SEARCHWORKER_INDEX_UTILS_ORDERED_KEY_VALUE_H_
