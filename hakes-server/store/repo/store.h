 ...
 * 
 * This is an abstract base class that defines the interface for storage operations.
 * Subclasses should implement specific storage backends (e.g., MongoDB, etc.).
 */
class Store {
 public:
  /**
   ...
   */
  virtual std::pair<std::vector<std::vector<uint8_t>>, std::vector<std::vector<uint8_t>>> 
