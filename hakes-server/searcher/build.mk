...
COMMON_INCLUDE_FLAGS = -I. -I${PROJECT_ROOT_DIR}/include -I${PROJECT_ROOT_DIR} -I${HAKES_ROOT_DIR}/hakes-server/common
...
## other srcs
src/io.o: ${HAKES_ROOT_DIR}/hakes-server/common/utils/io.cpp
	$(CXX) ${App_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"

src/fileutil.o: ${HAKES_ROOT_DIR}/hakes-server/common/utils/fileutil.cpp
	$(CXX) ${App_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"

src/hexutil.o: ${HAKES_ROOT_DIR}/hakes-server/common/utils/hexutil.cpp
	$(CXX) ${App_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"

src/json.o: ${HAKES_ROOT_DIR}/hakes-server/common/utils/json.cpp
	$(CXX) ${App_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"

src/searchservice.o: ${HAKES_ROOT_DIR}/hakes-server/common/server/message/searchservice.cpp
	$(CXX) ${App_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
...
server/service.o: $(HAKES_ROOT_DIR)/hakes-server/common/server/service.cpp
	$(CXX) $(App_Cpp_Flags) $(Server_Additional_Include_Flags) -c $< -o $@
	@echo "CXX <= $<"

server/server.o: $(HAKES_ROOT_DIR)/hakes-server/common/server/server.cpp
	$(CXX) $(App_Cpp_Flags) $(Server_Additional_Include_Flags) -c $< -o $@
	@echo "CXX <= $<"
