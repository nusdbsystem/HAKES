...
#ifndef HAKES_SEARCHWORKER_INDEX_INDEX_H_
#define HAKES_SEARCHWORKER_INDEX_INDEX_H_
...
struct Index {
    ...
    virtual bool get_is_trained() const { return is_trained; }
    virtual idx_t get_ntotal() const { return ntotal; }
