...
#ifndef HAKES_SEARCHWORKER_INDEX_IMPL_SIMD_RESULT_HANDLERS_H_
#define HAKES_SEARCHWORKER_INDEX_IMPL_SIMD_RESULT_HANDLERS_H_
...
#include "index/utils/simdlib.h"

// #include <faiss/impl/FaissAssert.h>
#include "index/impl/ResultHandler.h"
// #include <faiss/impl/platform_macros.h>
#include "index/utils/AlignedTable.h"
// #include <faiss/utils/partitioning.h>
#include "index/ext/TagChecker.h"
...
extern bool simd_result_handlers_accept_virtual;
...
void dispatch_SIMDResultHanlder_fixedCW(
    ...
    //     consumer.template f<ReservoirHandler<C, W>>(*resh, args...);
        ...
        //         typeid(res).name());
        assert(simd_result_handlers_accept_virtual);
...
#endif  // HAKES_SEARCHWORKER_INDEX_IMPL_SIMD_RESULT_HANDLERS_H_
