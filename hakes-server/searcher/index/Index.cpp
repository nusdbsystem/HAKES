...
#include "index/impl/DistanceComputer.h"
...
void Index::range_search(
    ...
    assert(!"range search not implemented");
}
...
void Index::add_with_ids(
    ...
    assert(!"add_with_ids not implemented for this type of index");
}

size_t Index::remove_ids(const IDSelector& /*sel*/) {
    // FAISS_THROW_MSG("remove_ids not implemented for this type of index");
    assert(!"remove_ids not implemented for this type of index");
    return -1;
}

void Index::reconstruct(idx_t, float*) const {
    // FAISS_THROW_MSG("reconstruct not implemented for this type of index");
    assert(!"reconstruct not implemented for this type of index");
}
...
size_t Index::sa_code_size() const {
    ...
    assert(!"standalone codec not implemented for this type of index");
}
...
DistanceComputer* Index::get_distance_computer() const {
    if (metric_type == METRIC_L2) {
        ...
        assert(!"get_distance_computer() not implemented");
    }
}
