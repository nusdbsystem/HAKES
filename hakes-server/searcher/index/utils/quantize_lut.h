...
#ifndef HAKES_SEARCHWORKER_INDEX_UTILS_QUANTIZE_LUT_H_
#define HAKES_SEARCHWORKER_INDEX_UTILS_QUANTIZE_LUT_H_
...
#endif  // HAKES_SEARCHWORKER_INDEX_UTILS_QUANTIZE_LUT_H_
