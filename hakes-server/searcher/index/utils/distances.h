...
#ifndef HAKES_SEARCHWORKER_INDEX_UTILS_DISTANCES_H_
#define HAKES_SEARCHWORKER_INDEX_UTILS_DISTANCES_H_
...
#endif  // HAKES_SEARCHWORKER_INDEX_UTILS_DISTANCES_H_
