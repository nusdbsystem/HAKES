...
#ifndef HAKES_SEARCHWORKER_INDEX_INVLISTS_INVERTEDLISTS_H_
#define HAKES_SEARCHWORKER_INDEX_INVLISTS_INVERTEDLISTS_H_
...
// guoyu0605 disable all other unused inverted lists implementation
