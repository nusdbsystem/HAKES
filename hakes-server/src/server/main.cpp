...
#include "gateway/data_manager.h"
#include "gateway/data_manager_impl.h"
#include "gateway/worker.h"
...
// UV_THREADPOOL_SIZE=10 ./install/bin/hakes_server 2355
// ../data/hakesworker/sample-config.json 0
