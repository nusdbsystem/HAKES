...
COMMON_INCLUDE_FLAGS = -I. -I$(PROJECT_ROOT_DIR)/include -I${HAKES_ROOT}/hakes-server/common -I${HAKES_ROOT}/hakes-server/embedder -I./src
...
src/fs_store.o: $(HAKES_ROOT)/hakes-server/embedder/store-client/fs_store.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"
