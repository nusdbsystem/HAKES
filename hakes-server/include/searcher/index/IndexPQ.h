...
#ifndef HAKES_SEARCHWORKER_INDEX_INDEXPQ_H_
#define HAKES_SEARCHWORKER_INDEX_INDEXPQ_H_

#include <stdint.h>

#include <vector>

#include "index/IndexFlatCodes.h"
...
extern int multi_index_quantizer_search_bs;
...
#endif  // HAKES_SEARCHWORKER_INDEX_INDEXPQ_H_
