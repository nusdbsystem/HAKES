...
void LinearTransform::reverse_transform(idx_t n, const float* xt, float* x)
    ...
    if (is_orthonormal) {
        ...
        assert(!"reverse transform not implemented for non-orthonormal matrices");
    }
}
...
// guoyu0605 disable all vector transforms
// /*********************************************
