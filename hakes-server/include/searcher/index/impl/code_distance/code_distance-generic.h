...
#ifndef HAKES_SEARCHWORKER_INDEX_CODE_DISTANCE_GENERIC_H_
#define HAKES_SEARCHWORKER_INDEX_CODE_DISTANCE_GENERIC_H_
...
#endif  // HAKES_SEARCHWORKER_INDEX_CODE_DISTANCE_GENERIC_H_
