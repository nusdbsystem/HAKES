...
src/base64.o: $(HAKES_ROOT)/hakes-server/common/utils/base64.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/fileutil.o: $(HAKES_ROOT)/hakes-server/common/utils/fileutil.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/hexutil.o: $(HAKES_ROOT)/hakes-server/common/utils/hexutil.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/http.o: $(HAKES_ROOT)/hakes-server/common/utils/http.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/json.o: $(HAKES_ROOT)/hakes-server/common/utils/json.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"
...
src/search_result_agg.o: src/search_result_agg.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/workerimpl.o: src/workerimpl.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

## embed endpoint
src/endpoint.o: $(HAKES_ROOT)/hakes-server/gateway/embed-endpoint/endpoint.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/openai_endpoint.o: $(HAKES_ROOT)/hakes-server/gateway/embed-endpoint/openai_endpoint.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/huggingface_endpoint.o: $(HAKES_ROOT)/hakes-server/gateway/embed-endpoint/huggingface_endpoint.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"

src/ollama_endpoint.o: $(HAKES_ROOT)/hakes-server/gateway/embed-endpoint/ollama_endpoint.cpp
	$(CXX) $(App_Cpp_Flags) -c $< -o $@
	@echo "CXX <= $<"
## embed endpoint
...
app: src/app.cpp libhakes_worker.a
	$(CXX) $(App_Cpp_Flags) $< -o $@ -L. -l:libhakes_worker.a $(App_Link_Flags)

# ## Build embed server ##

Server_Additional_Include_Flags := -Iserver -I$(LIBUV_DIR)/include -I$(LLHTTP_DIR)/include -I$(HAKES_ROOT)/server/common/http
...
server/hakes_worker.o: server/hakes_worker.cpp
	$(CXX) $(App_Cpp_Flags) $(Server_Additional_Include_Flags) -c $< -o $@
	@echo "CXX <= $<"
